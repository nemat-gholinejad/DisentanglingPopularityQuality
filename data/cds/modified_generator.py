...
with open(os.path.join(os.path.dirname(__file__), 'removable_items_cds_30.txt'), 'r') as f:
...
with open(f'/home/dsls/Desktop/projects/nematgh/Disentangled/data/cds/{dir_name}/val_on.txt', 'w') as f1, open(f'/home/dsls/Desktop/projects/nematgh/Disentangled/data/cds/{dir_name}/test_on.txt', 'w') as f2:
